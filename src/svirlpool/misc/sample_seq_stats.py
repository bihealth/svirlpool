...
DATA_ALIGNMENTS = {
    "dummy": Path(
        "/home/vinzenz/development/LRSV-detection/development/HG/trio/HG002/consensus.bam"
    ),
...
REFERENCE = Path(
    "/home/vinzenz/development/LRSV-detection/development/reference/hs37d5/hs37d5.fa"
)
REPEATS = Path(
    "/home/vinzenz/development/LRSV-detection/development/reference/hs37d5/human_hs37d5.trf.bed"
)
MIN_SV_SIZE = 6
SAMPLE = "HG002"

ALL_SIGNALS_PATH = Path(
    f"/home/vinzenz/development/LRSV-detection/development/HG/trio/{SAMPLE}.all_signals.json.gz"
)
...
DATAFRAME_PATH = Path(
    f"/home/vinzenz/development/LRSV-detection/development/HG/trio/{SAMPLE}.dataframe.tsv.gz"
)
